<template>
    <div v-if="!promiseState.promise">
        <div v-if="dependencyPromiseState">
            <PromiseNoData :promiseState="dependencyPromiseState" />
        </div>
        <p v-else>No data</p>
    </div>
...
export default {
    props: ["promiseState", "dependencyPromiseState"],
    //setup(){
    ...
    created() {
        ...
        //console.log(this.dependencyPromiseState);
    }
}
